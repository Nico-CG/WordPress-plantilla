<?php
    ...
    function enqueue_styles_scripts() {
        ...
        // Remember to comment out enqueueing of navigation.js in function.php
        // Note jquery listed as dependency which prompts WP to load it
    ...
    function add_continue_wrapper( $link, $text ) {
        ...
        $html = '<div class="continue_btn">' .$link . '</div>div>';
        return $html;
    }
